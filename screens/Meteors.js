            ...
            <ImageBackground source={bg_img} style={styles.backgroundImage}>
                        <View styles={styles.gifContainer}>
                            ...
                            <View>
                                ...
                                <Text style={[styles.cardText, { marginTop: 5, marginLeft: 50}]}> Diametro Minima (KM) - {item.estimated_diameter.kilometers.estimated_diameter_min}</Text>
                                <Text style={[styles.cardText, { marginTop: 5, marginLeft: 50}]}> Diametro Maxima (KM) - {item.estimated_diameter.kilometers.estimated_diameter_max}</Text>
                                ...
                                <Text style={[styles.cardText, { marginTop: 5, marginLeft: 50}]}> Distancis da Terra (KM) - {item.close_approach_data[0].miss_distance.kilometers}</Text>
                            </View>
                        </View>
            </ImageBackground>
        </View>
